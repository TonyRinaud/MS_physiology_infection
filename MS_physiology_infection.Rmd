...
ggsave(fig4,filename = "./Figs/Fig4_predicted_physio_param_infection_intensities_Treatment2.png",units = "px", width = 3700, height = 3700)
...
## Saving Figure 3
## -----------------------------------------------------------------------------
fig3 = tolres + g + plot_layout(width=c(1,2)) &  
  theme(plot.tag = element_text(size = 16, face = "bold")) 
fig3

ggsave(fig3,filename = "./Figs/Fig3.2_delta_body_condition_to_parasitemia_second.png",units = "px", width = 3700, height = 1700)
...
figS1 <- Fig_S1A + Fig_S1B + Fig_S1C2 + Fig_S1D + plot_annotation(tag_levels = 'a') & 
  theme(plot.tag = element_text(size = 16, face = "bold"))
figS1
...
ggsave(figS1,filename = "./Figs/FigS1_predicted_physio_param_infection_stages_Treatment2.png",units = "px", width = 3700, height = 3700)
...
ggsave(figs2,filename = "./Figs/FigS2_observed_physio_param_infection_stages_Treatment.png",units = "px", width = 3500, height = 3800)
...
ggsave(figs3,filename = "./Figs/FigS3_observed_physio_param_parasitemia_Treatment.png",units = "px", width = 3500, height = 3800)
...
## Additional figure: body condition at first sampling according to L. prevalence
##------------------------------------------------------------------------------
...
ggsave(figs6,filename = "./Figs/FigS6_body_condition_1_to_prevalence.png",units = "px", width = 3700, height = 3700)
```
