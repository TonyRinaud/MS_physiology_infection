...
Fig_4C = ggplot(mod_bc_para) + 
  ...
  labs(x = "Parasitemia", y = "Δ Body condition") + 
...
Fig_4D = ggplot(mod_gr_para) + 
  ...
  labs(x = "Parasitemia", y = "Growth rate") + 
...
Fig_S3C = ggplot(df[!df$Infection_intensity.2 %in% NA,]) + 
  ...
  geom_hline(yintercept = mean(df$delta_body_condition, na.rm = T), linetype = "dashed") + 
  labs(x = "Parasitemia", y = "\U0394 Body condition") + 
  geom_jitter(color = "lightgrey", size = 2, width = .3) + 
  stat_summary(fun = mean, colour = "cornflowerblue", geom = "errorbar", 
               size = 2.8 , width = 0.05, show.legend = FALSE, 
               fun.max = function(x) mean(x) + sd(x),
...
Fig_S5A = plot_model(
  ...
  title = "Breathing rate",
  axis.labels = 
    rev(c("Parasitemia [2] : Treatment [Malarone]","Age (days)",
          "Parasitemia 1", "Parasitemia 4",
          "Parasitemia [1] : Treatment [Malarone]",
          "Parasitemia [3] : Treatment [Malarone]",
          "Parasitemia [0] : Treatment [Malarone]",
          "Sex [Males]","Parasitemia 3","Sampling interval",
          "Parasitemia 2","Weight (g)","Ambient temperature",
          "Year [2019]","Year [2018]","Year [2020]")))
...
Fig_S5B = plot_model(
  ...
  axis.labels = 
    rev(c("Ambient temperature","Year [2020]","Age (days)",
          "Parasitemia [3] : Treatment [Malarone]",
          "Parasitemia 1", "Parasitemia [2] : Treatment [Malarone]",
          "Weight (g)","Parasitemia 2","Sex [Males]",
          "Parasitemia [0] : Treatment [Malarone]",
          "Parasitemia [1] : Treatment [Malarone]",
          "Parasitemia 3", "Sampling interval","Parasitemia 4")))
...
Fig_S5C = plot_model(
  ...
  axis.labels = 
    rev(c("Year [2020]","Year [2018]","Year [2019]",
          "Parasitemia [2] : Treatment [Malarone]",
          "Parasitemia 1","Sampling interval",
          "Parasitemia [3] : Treatment [Malarone]",
          "Parasitemia [0] : Treatment [Malarone]",
          "Age (days)","Sex [Males]","Parasitemia 3",
          "Parasitemia 2","Parasitemia [1] : Treatment [Malarone]",
          "Parasitemia 4")))
...
Fig_S5D = plot_model(
  ...
  title = "Growth rate", 
  axis.labels = 
    rev(c("Year [2020]","Parasitemia [2] : Treatment [Malarone]",
          "Year [2018]","Year [2019]","Sampling interval","Parasitemia 1",
          "Parasitemia [3] : Treatment [Malarone]",
          "Parasitemia [0] : Treatment [Malarone]",
          "Parasitemia 3","Sex [Males]","Parasitemia 2",
          "Age (days)","Parasitemia 4","Parasitemia [1] : Treatment [Malarone]")))
