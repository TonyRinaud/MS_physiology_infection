...
treatment_meaninf_changes = ggplot(mean_infint) +
  ...
  stat_summary(fun = mean, mapping = aes(group=Treatment), geom = "line",size = 2,color = c("lightgrey","black","black","lightgrey"))+ 
...
tab_model(
  ...
  file = "./Tables/TableS1_Physiological_parameters_in_decreasing_control_treated.html")
```
...
fig4 <- gg1_pred + gg2_pred + gg3_pred + gg4_pred + plot_annotation(tag_levels = 'A') & 
  theme(plot.tag = element_text(size = 16, face = "bold"))
ggsave(fig4,filename = "./Figs/Fig4_predicted_physio_param_infection_stages.png",units = "px", width = 3700, height = 3700)
...
sjPlot::tab_model(
  ...
  df.method = "kr",
  dv.labels = c("Breathing rate","Body temperature","\U0394 Body condition","Growth rate"),
  file = "./Tables/Table3_results_lmer_physiological_parameters_p.val_kr.html")
```
...
ggsave(fig5,filename = "./Figs/Fig5_predicted_physio_param_infection_intensities.png",units = "px", width = 3700, height = 3700)
...
sjPlot::tab_model(lmer_br_para,lmer_bt_para,lmer_bc_para,lmer_gr_para,
                  ...
                  p.val = "kr",
                  dv.labels = c("Breathing rate","Body temperature","\U0394 Body condition","Growth rate"),
                  file = "./Tables/Table4_results_parasitemia_lmer_physiological_parameters_p.val_kr.html")
...
ggsave(g,filename = "./Figs/Fig3_delta_body_condition_to_parasitemia_second.png",units = "px", width = 3700, height = 2800)
```
...
ggsave(figs1,filename = "./Figs/FigS1_observed_physio_param_infection_stages.png",units = "px", width = 3500, height = 3800)
...
ggsave(figs2,filename = "./Figs/FigS2_observed_physio_param_parasitemia.png",units = "px", width = 3500, height = 3800)
...
ggsave(figs3,filename = "./Figs/FigS3_effect_sizes_param_stages.png",units = "px", width = 3500, height = 3800)
...
ggsave(figs4,filename = "./Figs/FigS4_effect_sizes_param_intensities.png",units = "px", width = 3500, height = 3800)
```
